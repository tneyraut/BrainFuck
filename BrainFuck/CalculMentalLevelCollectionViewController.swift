...
class CalculMentalLevelCollectionViewController: UICollectionViewController {
    ...
    private func goToGameViewWithLevel(level: Int)
    {
        ...
        calculMentalGameViewController.level = level
    ...
    override func collectionView(collectionView: UICollectionView, didSelectItemAtIndexPath indexPath: NSIndexPath) {
        if (self.endlessMod)
        {
            ...
            let alertActionScore = UIAlertAction(title:"Scores", style:.Default) { (_) in
                ...
                scoreTableViewController.identifier = "CalculMentalLevelN°" + String(indexPath.row + 1)
                
                scoreTableViewController.theTitle = "Calcul Mental : Scores"
